...
namespace Api.Test.Steps
{
    ...
    public class HomeDiarioSteps
    {
        ...
        public HomeDiarioSteps(SeleniumContext selenium)
        {
            this.seleniumContext = selenium;
        }
        ...
        public void GivenIngresoLaDireccionDelSitioDelDiario()
        {
            ...
            //_chromeOptions.AddArguments(new List<string>() {"--incognito", "headless" } ); // "headless", 
            //_driver = new ChromeDriver(_chromeOptions);
            //_wait = new WebDriverWait(_driver, TimeSpan.FromSeconds(30));

           //  _driver.Manage().Window.Maximize();
            //_driver.Navigate().GoToUrl("http://www.lanacion.com.ar");
            seleniumContext.WebDriver.Navigate().GoToUrl("http://www.lanacion.com.ar");
        }
        ...
        public void ThenVisualizoLaPortadaYVeoElLogoDelDiario_()
        {
            ...
            bool existLogo = seleniumContext.WebDriver.FindElement(By.CssSelector(".banner-header-logo")).Displayed;
